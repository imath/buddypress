...
class BP_Members_Admin {
	...
	public function profile_admin_head() {
		...
		if ( is_user_admin() ) {
			...
			$this->user_notices_url = add_query_arg( $this->user_notices_args, admin_url( 'users.php' ) );
	...
	public function enqueue_scripts() {
		...
		if ( bp_members_is_community_profile_enabled() && get_current_screen()->id == $this->user_page ) {
